...
const EditSectionForm = ({
  ...
  return (
    <>
      ...
      <h1 className="text-xl font-semibold">Section Details</h1>
      <p className="text-sm font-medium mt-2">
        Complete this section with detailed information , good video content and
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                <div className="space-y-0.5">
                  <FormLabel className="text-base">Accessability</FormLabel>
                  <FormDescription>
